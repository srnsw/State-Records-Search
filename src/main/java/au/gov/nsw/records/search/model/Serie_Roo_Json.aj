...
privileged aspect Serie_Roo_Json {
    ...
    public String Serie.toJson(String[] fields) {
        return new JSONSerializer()
        .include(fields).exclude("*.class").serialize(this);
    }
    
    public static Serie Serie.fromJsonToSerie(String json) {
        return new JSONDeserializer<Serie>()
        .use(null, Serie.class).deserialize(json);
    }
    ...
    public static String Serie.toJsonArray(Collection<Serie> collection, String[] fields) {
        return new JSONSerializer()
        .include(fields).exclude("*.class").serialize(collection);
    }
    
    public static Collection<Serie> Serie.fromJsonArrayToSeries(String json) {
        return new JSONDeserializer<List<Serie>>()
        .use("values", Serie.class).deserialize(json);
    }
